...
var yaml_1 = __importDefault(__webpack_require__(521));
var fs_1 = __importDefault(__webpack_require__(747));
var extract_container_data_1 = __webpack_require__(427);
var run = function () {
    var tag = process.env.TAG || core_1.getInput('tag');
    var deploymentName = process.env.IMAGE || core_1.getInput('name');
    var deployment = process.env.DEPLOYMENT_MANIFEST || core_1.getInput('deployment');
    if (!fs_1.default.existsSync(deployment)) {
        throw new Error("Unable to find " + deployment);
    }
    var fileContents = fs_1.default.readFileSync(deployment, 'utf8');
    if (fileContents === '') {
    ...
    var modifiedData;
    var originalData;
    yamlDocuments.forEach(function (document) {
        ...
        containers.forEach(function (c) {
            var containerData = extract_container_data_1.extractContainerData(c.image);
            ...
            if (containerData.image === deploymentName) {
                var newValue = "" + containerData.image;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.extractContainerData = void 0;
var extractContainerData = function (str) {
    var registryRegex = /(.*\/)/;
    var tagRegex = /(?<=:)(?<tag>.+)/;
    var registry;
    var author;
    ...
    var tagPosition = str.search(tagRegex);
    if (tagPosition !== -1) {
        tag = str.substring(tagPosition);
        str = str.substr(0, tagPosition - 1);
    }
    var imagePrefixParts = str.split(registryRegex);
    ...
    if (registry) {
        ...
        var registryParts = registry.replace(/[\/]+$/, "").split('/');
...
exports.extractContainerData = extractContainerData;
